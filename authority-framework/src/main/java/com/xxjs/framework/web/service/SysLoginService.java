...
import com.xxjs.common.utils.DateUtils;
import com.xxjs.common.utils.StringUtils;
import com.xxjs.framework.security.context.AuthenticationContextHolder;
import com.xxjs.system.service.ISysConfigService;
...
public class SysLoginService
{
    ...
    //需要我们在 WebSecurityConfigurerAdapter 实现类下面进行重写 AuthenticationManager 并且注入到 spring 容器中（Bean）
    //不然报错 Consider defining a bean of type 'org.springframework.security.authentication.AuthenticationManager' in your configuration
    @Resource
