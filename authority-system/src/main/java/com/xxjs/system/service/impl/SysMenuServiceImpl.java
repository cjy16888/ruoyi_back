...
import com.xxjs.common.core.domain.TreeSelect;
...
import com.xxjs.system.domain.vo.MetaVo;
import com.xxjs.system.domain.vo.RouterVo;
import com.xxjs.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public Set<String> selectMenuPermsByUserId(Long userId)
    {
        ...
        for (String perm : perms)
        {
            ...
            {
                //其实这里的不需要后面的  split 可以的
                //因为 perm 取出来的值是 system:user:list 这种形式的，或者是 ‘’ 空
